...
def anc_visit(request):
    ...
    ########################################################
        ...
        cur.execute("""UPDATE smo_anc SET weight=array_append(weight, %s::DOUBLE) ,bp_1=array_append(bp_1, %s) ,bp_2=array_append(bp_2, %s) ,malrepresentation=array_append(malrepresentation, %s) ,gdm=array_append(gdm, %s) ,
