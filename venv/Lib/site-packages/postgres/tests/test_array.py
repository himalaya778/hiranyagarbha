...
from postgres.forms import SimpleArrayField, SplitArrayField
from postgres.tests.models import IntegerArrayModel, NullableIntegerArrayModel, CharArrayModel, DateTimeArrayModel, NestedIntegerArrayModel
...
class TestSerialization(TestCase):
    test_data = '[{"fields": {"field": "[\\"1\\", \\"2\\"]"}, "model": "tests.integerarraymodel", "pk": null}]'
